...
public partial class HDevelopExport
{
  ...
  private void action()
  {
    ...
    try
    {
      //┤╦╬к╫ю╝Є╜р░ц▒╛╡─═╞└э┤·┬ыгм▒╚Halcon╫╘┤°└¤╫╙╝Є╡е╨э╢р╨э╢ргм╫ў╒▀г║╣у╓▌╟▒┴·гм└┤╫╘GPNU 2023.9.23гм╫к╘╪╟ы╫в├ў│Ў┤жбг
      //1 ╚б╡├╤╡┴╖║├╡──г╨═гм─г╨═┤╙DTL└я╡╝│Ўгм╖┼╓├╙┌═м╥╗─┐┬╝╧┬
      hv_DLModelHandle.Dispose();
      HOperatorSet.ReadDlModel("model", out hv_DLModelHandle);
      ...
      //╤н╗╖╢┴═╝║══╞└э
      ho_Image.Dispose();
      HOperatorSet.ReadImage(out ho_Image, "D:/desk/╖╓╕ю/imgs/1 (1).png");
      //─├╡╜╩╡╝╩═╝╞м┤є╨б
